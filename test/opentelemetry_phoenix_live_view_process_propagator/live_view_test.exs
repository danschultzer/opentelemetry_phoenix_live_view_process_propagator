defmodule OpentelemetryPhoenixLiveViewProcessPropagator.LiveViewTest do
  ...
  defmodule TestLive do
    ...
    def handle_async(:start_async, {:ok, value}, socket) do
      {:noreply, assign(socket, :start_async, AsyncResult.ok(value))}
    end
  ...
  defmodule Endpoint do
    use Phoenix.Endpoint, otp_app: :opentelemetry_phoenix_live_view_process_propagator
  ...
  setup do
    Application.put_env(
      :opentelemetry_phoenix_live_view_process_propagator,
      Endpoint,
